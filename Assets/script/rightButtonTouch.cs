...
public class rightButtonTouch : MonoBehaviour {
	...
	void OnMouseDown(){  // 버튼을 MouseDown 할 때 이벤트
		...
		Sprite rightBall2 = _ball.original4.GetComponent<SpriteRenderer> ().sprite;
		Sprite rightBall3 = _ball.original6.GetComponent<SpriteRenderer> ().sprite;


        Sprite spr1 = ball1.GetComponent<SpriteRenderer>().sprite;

		if (spr1 == rightBall || spr1 == rightBall2 || spr1 == rightBall3) {
            // 나머지 공 애니메이션
